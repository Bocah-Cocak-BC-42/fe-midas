...
import Logo from "./../../assets/logo-midas.svg";
      ...
      <div className="bg-[#FFF7D4] h-20 flex flex-row items-center justify-around">
        ...
        <div className="nav_link flex-auto text-center">
          ...
          >
            <li className="py-2">
              <a href="#">
                <FontAwesomeIcon className="nav_icon" icon={faCircleInfo} />{" "}
                Tentang Kami
              </a>
            </li>
            <li className="py-2">
              <a href="#">
                <FontAwesomeIcon icon={faTags} className="nav_icon" /> Produk
              </a>
            </li>
            <li className="py-2">
              <a href="#">
...
export default HeaderUmumComponent;
